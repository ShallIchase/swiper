...
class Swiped(models.Model):
	...
	def is_liked(cls, uid, sid):
		'''检查是否喜欢过某人'''
		cls.objects.filter(uid=uid, sid=sid, 
						   status__in=['like', 'superlike']).exist()
...
class Friend(models.Model):
	...
	def be_friends(cls, uid1, uid2):
		'''成为好友'''
		uid1, uid2 = (uid1, uid2) if uid1 < uid2 else (uid2, uid2)
	...
	def friends(cls, uid):
		...
		friend_id_list = []
		for r in relations:
			friend_id = r.uid2 if uid1 == uid else r.uid1
